  ...
  v-app(dark)
    v-content.default-layout
      ...
      v-layout.default-content
        nuxt
    a(href="https://github.com/hunterliu1003" class="github-corner" aria-label="View source on GitHub")
      svg(width="80" height="80" viewBox="0 0 250 250" style="fill:#64CEAA; color:#fff; position: fixed; top: 0; border: 0; right: 0;" aria-hidden="true")
